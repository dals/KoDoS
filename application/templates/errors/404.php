        ...
        <!--
            <div id="header">
                ...
                <div id="top">
                    ...
                    <div class="left navigation" id="main-nav">
                        ...
                        <ul class="tabbed">
                            <li class="current-tab"><a href="/index">Blog</a></li>
            ...
            <div class="main" id="main-two-columns">
                <div style="border:1px solid red;padding:20px 20px;">
                    <h1 style="color:red;float:left;margin-right:30px;">404</h1>
                    <h2 style="color:#94CC5F;clear:both;">Page not found</h2>
                    <h3 style="margin-top:30px;">Oops! The page that you requested was not found!</h3>
                </div>
                <div class="clearer">&nbsp;</div>
            </div>
<!--
            <div id="footer">
                ...
                <div class="left" id="footer-left">
                    ...
                    <img src="assets/images/logo-small.gif" alt="" class="left" />
